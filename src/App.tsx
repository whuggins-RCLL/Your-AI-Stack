...
export default function App() {
  ...
  const isDiscontinuedPage = typeof window !== 'undefined' && window.location.pathname === '/discontinued-ai';
      ...
      <main className="pb-16 max-w-[1100px] mx-auto px-4 sm:px-5">
        ...
        <section className="mb-8 bg-gradient-to-br from-surface-container-lowest via-white to-surface shadow-[0_16px_40px_rgba(26,28,27,0.08)] border border-outline-variant/35 rounded-3xl p-6 md:p-8">
          <div className="w-full">
            <div className="grid items-center gap-4 mb-4 md:grid-cols-[1fr_auto] md:gap-6">
              <h2 className="font-headline text-3xl md:text-4xl font-semibold text-on-surface tracking-tight">What is an "AI Stack"?</h2>
              <button
        ...
        <section className="mb-8 bg-gradient-to-br from-surface-container-lowest via-white to-surface shadow-[0_16px_40px_rgba(26,28,27,0.08)] border border-outline-variant/35 rounded-3xl p-6 md:p-8">
          <div className="w-full">
            <div className="grid items-center gap-4 mb-6 md:grid-cols-[1fr_auto] md:gap-6">
              <h2 className="font-headline text-3xl md:text-4xl font-semibold text-on-surface tracking-tight">Build your AI stack around the work that matters.</h2>
              <button
        ...
        <section className="mb-16 bg-surface-container-lowest border border-outline-variant/30 rounded-2xl p-8 shadow-sm">
          <div className="grid items-center gap-4 mb-6 md:grid-cols-[1fr_auto] md:gap-6">
            <h2 className="font-headline text-3xl md:text-4xl font-semibold text-on-surface tracking-tight">Major, General Purpose Large Language Models (LLMs)</h2>
            <button
